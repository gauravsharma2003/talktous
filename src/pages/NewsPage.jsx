...
export default function NewsPage() {
    ...
    return (
        ...
        >
            ...
            >
                {/* Tabs */}
                <div className="flex justify-around items-center pt-5 pb-3 border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur z-10">
                    <div className="flex flex-col items-center">
                        <span className="font-bold text-[17px] text-black">Top News</span>
                        <div className="w-12 h-1 bg-black mt-2 rounded-full" />
                    </div>
                    <span className="text-[17px] text-gray-400">For You</span>
                    <span className="text-[17px] text-gray-400">ePaper</span>
                </div>
                ...
                <div className="pb-[calc(110px+env(safe-area-inset-bottom))]">
                    {visibleArticles.map((article, idx) => {
                        ...
                        return (
                            <div key={article.id} className="px-4 sm:px-6 py-4 border-b border-gray-50">
                                    ...
                                    {article.hasImage && (
                                        <div className="shrink-0">
                                            <ImageWithFallback
                                                ...
                                                alt="Article"
                                                className="w-28 h-20 sm:w-32 sm:h-24 object-cover rounded-lg bg-gray-50"
                                            />
                                        </div>
                                    )}
                                </div>
